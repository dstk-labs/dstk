...
import { ModelVersionLoader } from '@/features/modelVersions/loaders/modelVersionLoader';

import styles from './ModelVersionLayout.module.css';

type TabValues = 'artifacts' | 'card' | 'logs';

export const ModelVersionLayout = () => {
      ...
      <header className={styles.header}>
        <div className={styles.attributes}>
          <div className={styles.status}>
            <Title order={4}>
              Version {data.getMLModelVersion?.numericVersion}
            </Title>
            <Badge
              color={
