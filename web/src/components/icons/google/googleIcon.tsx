...
export const GoogleIcon = ({ height, width, ...props }: GoogleIconProps) => (
  <svg height={height} width={width} viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
